...
import Data from '@/data_json/kospi_data_1month.json';
import Data_6 from '@/data_json/kospi_data_6month.json';
import LineChart from '@/components/chart/kospi_chart.vue'
import LineChart_6 from '@/components/chart/kospi_chart_6.vue'
